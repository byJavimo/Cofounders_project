Rails.application.routes.draw do
  ...
  delete 'users/:user_id/skills/:id'=> 'skills#destroy_user_skill', as: 'delete_user_skill'
  delete 'projects/:project_id/:id' => 'skills#destroy_project_skill', as: 'delete_project_skill'
